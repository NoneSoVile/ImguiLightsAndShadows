...
class SKShader;
class SSAO: public ShaderTester
{
public:
...
protected:
    std::shared_ptr<SKShader> shaderGeometryPass;
    std::shared_ptr<SKShader> shaderLightingPass;
    std::shared_ptr<SKShader> shaderSSAO;
    std::shared_ptr<SKShader> shaderSSAOBlur;
